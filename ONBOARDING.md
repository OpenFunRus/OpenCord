...
- В history mode используется окно `50` с логикой `-25/+25` (якорение и скролл по центру).
- Переходы из поиска и закрепов грузят окно вокруг цели (`50`) и центрируют целевое сообщение.
...
- Для мобильной версии добавлено постоянное отображение верхних/нижних контролов карточек, так как hover на touch недоступен.
...
7. Проверить, что на мобильном видны верхние/нижние контролы карточек без необходимости hover.
