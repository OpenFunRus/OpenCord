...
- Поведение fullscreen-кнопки скорректировано: на desktop она показывается как часть hover-контролов, на mobile — видна всегда вместе с остальными контролами.
