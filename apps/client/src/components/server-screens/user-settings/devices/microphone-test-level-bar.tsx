    ...
    return (
      <div className="space-y-2">
        <div className="relative h-3 w-full">
          <div className="absolute inset-0 overflow-hidden rounded-full border border-[#2d3c4e] bg-[#101926] shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
            {noiseGateEnabled ? (
              <div className="absolute inset-0 flex">
                ...
                />
                <div className="flex-1 bg-[#1a2636]" />
              </div>
            ) : (
              <div className="absolute inset-0 bg-[#1a2636]" />
            )}
